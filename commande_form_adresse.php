    ...
    <!-- END nav -->
      ...
      <div class="container-login100" >
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30"  style=" right: 10% ;width: 700px">
				...
				<form class="login100-form validate-form" method="POST" enctype="multipart/form-data" action="recuperer.php" >
				  
        	<span class="login100-form-title p-b-55">
            Adresse
					</span>
<input type="hidden" name="id_cmd" value="97">

				<div class="wrap-input100 validate-input" data-validate="Name is required">
						<span class="label-input100">Nom et prénom</span>
						<input class="input100" type="text" name="nom_prenom" placeholder="foulen benfoulen" >
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid number">
						...
						<input class="input100" type="text" name="numero" placeholder="00 000 000">
						<span class="focus-input100"></span>
					</div>
...
<input type="hidden" name="total" " value="<?= $produit->prix + 6; ?>">
 <?php endforeach; ?>
					<div class="wrap-input100 validate-input" data-validate="Username is required">
						...
						<input class="input100" type="text" name="adresse" placeholder="Rue/Appartement/Suite/Bloc/Bâtiment">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<span class="label-input100">Région</span>
						<input class="input100" type="text" name="region" placeholder="">
						<span class="focus-input100"></span>
					</div>
          ...
          <div class="flex-m w-full p-b-33">
            <div class="contact100-form-checkbox">
				...
				<div class="container-login100-form-btn">
						...
						<button class="login100-form-btn" onclick="continuer()">
                confirmer
              </button>
						</div>
					</div>
